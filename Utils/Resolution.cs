...
{
    /**
     * Virtual Resolution: the resolution that the game uses internally. It will always be the same.
     * Resolution: the actual resolution of the game screen. Can be changed.
     */
    static class Resolution
    {
        ...
        public static float getInternalWidth()
        {
            return _VWidth;
        }

        public static float getInternalHeight()
        {
            return _VHeight;
        }
